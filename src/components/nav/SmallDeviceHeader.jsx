...
const SmallDeviceHeader = ({
	...
	return (
		<div className="header fixed md:hidden z-40 justify-between py-4 top-0 flex w-full">
			<div className={`relative mr-24 w-64 h-20 overflow-hidden rounded-2xl`}>
				<img
			...
			<div className="mr-auto sm:ml-auto px-4 flex gap-3 items-center">
			...
			{menuOpen && (
				<div className="fixed top-full right-0 z-50 flex flex-col gap-8 px-10 py-4 pb-8 h-screen w-fit">
					<div
						onClick={() => {
